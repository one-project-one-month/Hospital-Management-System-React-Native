...
export default function PatientManagementScreen() {
  ...
  const handleAddPatient = () => {
    if (newPatient.name && newPatient.age && newPatient.gender) {
      const patient: Patient = {
        ...
        image: `https://randomuser.me/api/portraits/${newPatient.gender.toLowerCase() === 'male' ? 'men' : 'women'}/${patients.length + 1}.jpg`,
  ...
  const handleEditPatient = () => {
    if (selectedPatient && newPatient.name && newPatient.age && newPatient.gender) {
